        ...
        <form className="flex flex-wrap gap-4 items-end">
          ...
          <div className="flex flex-col">
            ...
            <button
              ...
              className="cursor-pointer flex w-40 px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-500"
            >
          ...
          {/* 참여 정책 */}
          <div className="cursor-pointer flex flex-col w-70 relative">
            ...
            <button
              ...
              className="cursor-pointer flex items-center px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-500"
            >
                ...
                {selectedPolicies.map((policy, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="cursor-pointer ml-1 text-blue-400 hover:text-blue-600"
                    >
                      ×
                    </button>
                  </span>
          ...
          <button
            type="button"
            className="cursor-pointer flex items-center gap-2 px-10 py-3 text-white bg-blue-600 hover:bg-blue-700 text-sm font-medium rounded-md ml-auto"
          >
            검색하기
          </button>
        </form>
